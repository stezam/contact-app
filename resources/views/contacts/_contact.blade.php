<tr>
        ...
        <td width="150">
                @if($showTrashButtons)
                        ...
                        <form action="{{ route('contacts.force-delete', $contact->id) }}" method="POST" style="display: inline;" onsubmit="return confirm ('Are you sure you want to permantly delete this record?')">
                                @csrf
                                @method('delete')
